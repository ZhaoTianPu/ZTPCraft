...
def f1f2_with_loss(
    ...
    a1 = 1 / LJ1 / (1 / LJ1 + 1 / LJ2)
    a2 = 1 / LJ2 / (1 / LJ1 + 1 / LJ2)
    # G = -omega_p*1j*omega_q/(omega_q**2 - omega_p**2 + gamma**2/4 + 1j*gamma*omega_p)
    G = -(omega_q**2) / (omega_q**2 - omega_p**2 + gamma**2 / 4 + 1j * gamma * omega_p)
    mat = np.array([[1 + G * a1, G * a2], [G * a1, 1 + G * a2]])
    inv_mat = np.linalg.inv(mat)
    f1 = inv_mat[0, 0] * A1 + inv_mat[0, 1] * A2
    f2 = inv_mat[1, 0] * A1 + inv_mat[1, 1] * A2
    return f1, f2
